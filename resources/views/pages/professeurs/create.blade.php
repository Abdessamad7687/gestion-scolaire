...
@section('content')
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Créer un professeur</li>
        </ol>
    </nav>
    ...
    <form class="container mt-4" method="POST" action="{{ route('professeurs.store') }}">
        @csrf
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="specialite" id="specialite" value="{{ old('specialite') }}" required>
            </div>
            <div class="col-md-6">
                <label for="comissionfixe" class="form-label">Commission fixe</label>
                <input type="number" step="0.01" min="0" class="form-control" name="comissionfixe" id="comissionfixe" value="{{ old('comissionfixe') }}" required>
            </div>
        </div>
